...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .requestMatchers(HttpMethod.POST,"/parcels").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/parcels").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/parcels/amount").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/parcels/{id}").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,"/parcels/{id}").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE,"/parcels/{id}").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET,"/costs/list").hasRole("ADMIN")

                .requestMatchers(HttpMethod.GET,"/transactions/personnel").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/transactions/service").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/transactions/consumption").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/transactions/food").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/transactions/operationg").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT,"/suppliers/{id}").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE,"/suppliers/{id}").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,"/suppliers/list").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("https://afasc-manager.vercel.app");
